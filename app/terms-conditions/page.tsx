              ...
              <div className="space-y-8 text-zinc-600 dark:text-zinc-400">
                <section>
                  ...
                  <p className="leading-relaxed">
                    By accessing and using Autorithm (&quot;the Service&quot;),
                    you accept and agree to be bound by the terms and provision
                    of this agreement. In addition, when using these particular
                ...
                <section>
                  ...
                  <p className="leading-relaxed mb-4">
                    ...
                    functionality are owned by Autorithm and are protected by
                    international copyright, trademark, patent, trade secret,
                    and other intellectual property or proprietary rights laws.
                  </p>
                  <p className="leading-relaxed">
                    Our automation kits and workflows are licensed to you for
                    use within your business or for your personal projects. You
                    may not resell, redistribute, or sub-license the source code
                    or configuration files of our products without explicit
                    written permission.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <p className="leading-relaxed">
                    ...
                    automation workflows), we generally do not offer refunds
                    once the files have been downloaded. However, if you
                    encounter technical issues that we cannot resolve, please
                    contact support for assistance or to request a refund
