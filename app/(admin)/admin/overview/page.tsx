...
export default function DashboardOverview() {
  ...
  const recentOrders = [
    { id: "ORD001", customer: "Olivia Martin", email: "olivia.martin@email.com", amount: "$1,999.00", status: "Completed" },
    { id: "ORD002", customer: "Jackson Lee", email: "jackson.lee@email.com", amount: "$39.00", status: "Processing" },
    { id: "ORD003", customer: "Isabella Nguyen", email: "isabella.nguyen@email.com", amount: "$299.00", status: "Completed" },
    { id: "ORD004", customer: "William Kim", email: "will@email.com", amount: "$99.00", status: "Pending" },
    { id: "ORD005", customer: "Sofia Davis", email: "sofia.davis@email.com", amount: "$39.00", status: "Completed" },
  ];
  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-zinc-400 mt-1">Here&apos;s an overview of your store performance</p>
      </div>
          ...
          <div className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-zinc-400 mt-1">You made 265 sales this month.</p>
              </div>
              <Link href="/admin/purchases" className="text-sm text-blue-500 hover:text-blue-400">
                View All
              </Link>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm font-semibold text-white">2,350</span>
                </div>
                <div className="h-2 bg-zinc-800 rounded-full overflow-hidden">
          ...
          <div className="rounded-xl border border-zinc-800 bg-zinc-900/50 backdrop-blur-sm p-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                ...
                <span className="text-sm font-medium text-white">New Coupon</span>
              </Link>
              <Link
                href="/admin/users"
