          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-400 mt-1">
                Edit coupon details and view usage statistics
              </p>
            </div>
          </div>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-white mt-1">
                ${couponData.revenue.toLocaleString()}
              </p>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-white mt-1">
                ${(couponData.revenue / couponData.currentUses).toFixed(2)}
              </p>
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-5">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              {couponData.status === "Paused" && (
                <PauseCircleIcon className="h-6 w-6 text-amber-400" />
              )}
                ...
                <div className="space-y-4">
                  ...
                  <label className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-zinc-500 mt-0.5">
                        Restrict this coupon to customers who haven&apos;t made
                        a purchase before
                      </p>
                    </div>
                  </label>
                  ...
                  <label className="flex items-start gap-3 cursor-pointer group">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-xs text-zinc-500 mt-0.5">
                        Don&apos;t allow this coupon to be used on items already
                        on sale
                      </p>
                    </div>
                  </label>
