...
const navigation = [
  ...
  { name: 'Purchases', href: '/dashboard/purchases', icon: CreditCardIcon },
  ...
  return (
    <div className="flex flex-col w-64 bg-zinc-900 border-r border-zinc-800 min-h-screen fixed left-0 top-0 bottom-0">
      <div className="flex items-center justify-center h-16 border-b border-zinc-800">
        <span className="text-xl font-bold text-white tracking-wider">AUTORITHM</span>
      </div>
      ...
      <div className="p-4 border-t border-zinc-800">
         <Link href="/" className="flex items-center px-4 py-2 text-sm font-medium text-zinc-400 hover:text-white hover:bg-zinc-800 rounded-md transition-colors">
